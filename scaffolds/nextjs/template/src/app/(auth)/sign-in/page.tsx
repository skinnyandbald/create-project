  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <form onSubmit={handleSignIn} className="w-full max-w-sm space-y-4">
        ...
        <button type="submit" className="w-full rounded bg-foreground py-2 font-medium text-background">Sign In</button>
        <p className="text-center text-sm">No account? <a href="/sign-up" className="underline">Sign up</a></p>
      </form>
    </div>
  )
}

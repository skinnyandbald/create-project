    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="w-full max-w-sm space-y-4 text-center">
          ...
          <a href="/sign-in" className="text-sm underline">Back to sign in</a>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <form onSubmit={handleSignUp} className="w-full max-w-sm space-y-4">
        ...
        <button type="submit" className="w-full rounded bg-foreground py-2 font-medium text-background">Sign Up</button>
        <p className="text-center text-sm">Already have an account? <a href="/sign-in" className="underline">Sign in</a></p>
      </form>
    </div>
  )
}
